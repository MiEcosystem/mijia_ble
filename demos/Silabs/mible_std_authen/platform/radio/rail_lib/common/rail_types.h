...
/**
 * An option to configure whether the appended information is included after received
...
RAIL_ENUM(RAIL_RxPacketStatus_t) {
  ...
  RAIL_RX_PACKET_READY_CRC_ERROR, /**< A CRC error accepted (details available). */
...
typedef struct RAIL_RxPacketDetails {
  /**
   * The timestamp of the received packet in the RAIL timebase. The
