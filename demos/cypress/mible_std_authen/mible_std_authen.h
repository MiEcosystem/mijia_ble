...
#define MI_BLE_DID_VS_ID              (HELLO_SENSOR_PAIRED_KEYS_VS_ID +1) 
#define MI_BLE_TOKEN_VS_ID            (MI_BLE_DID_VS_ID +1)
#define MI_BLE_BEACONKEY_VS_ID        (MI_BLE_TOKEN_VS_ID +1)
