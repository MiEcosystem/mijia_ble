...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\common\bin\cspybat" -f "C:\Program Files (x86)\STMicroelectronics\BlueNRG-1_2 DK 2.6.0\Project\BLE_Examples\mijia_ble\demos\BlueNRG-1\mible_std_authen\EWARM\BlueNRG-1\settings\BLE_Chat.Server.general.xcl" "--debug_file=%~1" --backend -f "C:\Program Files (x86)\STMicroelectronics\BlueNRG-1_2 DK 2.6.0\Project\BLE_Examples\mijia_ble\demos\BlueNRG-1\mible_std_authen\EWARM\BlueNRG-1\settings\BLE_Chat.Server.driver.xcl" 
